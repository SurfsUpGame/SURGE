...
class SURGE_GenerateRamp(bpy.types.Operator):
    ...
    ramp_name : bpy.props.StringProperty (name= "", description = 'Name of the ramp mesh', default = 'ramp')
    material_name : bpy.props.StringProperty (name= "", description = 'Name of the material to assign', default = 'default')
...
#------------------------------------------------------------------------------------------------------
        ...
        # Spin the edges into the correct shape depending on ramp type, or extrude for straight ramps.
        ...
        elif self.ramp_enum == 'Straight':
            bpy.ops.mesh.extrude_region_move(TRANSFORM_OT_translate={"value":(0, self.size, 0), "orient_type":'GLOBAL'})
        ...
        # Handle Arc/Dip rotation before origin centering.
        bpy.ops.mesh.select_all(action = 'DESELECT')
        bpy.ops.object.editmode_toggle()
        ...
        # Center origin on geometry bounding box for all ramp types.
        ...
        # Rename the mesh to the user-provided name.
